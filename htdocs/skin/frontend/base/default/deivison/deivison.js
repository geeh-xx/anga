            ...
            */
            ...
            $j('input[name*="taxvat"]').blur( function(){
                ...
                if (v.length <= 11) { //CPF
                    ...
                    //Coloca um h�fen entre o terceiro e o quarto dígitos
                    ...
                    //Coloca um h�fen depois do bloco de quatro dígitos
            ...
            $j('input').click( function(){
                    $j('html head').find('title').text(  "Finalizando compra no campo [ " + $j(this).attr('title') + " ]"  );
...
/*  deivison 02
    FUNÇÃO QUE EXECUTA PASSO A PASSO DE ATUALIZA��O DOS CAMPOS PAYMENTS E REVIEW
    -------------------------------------------------------------------------------------------------------------------------------
    Essa função foi feita para atualização dos valores, caso haja desconto para pagamentos espec�ficos como 10% pagamento no boleto
    -------------------------------------------------------------------------------------------------------------------------------
...
$j(function($) {
      $j('input[name*="payment[method]"]').live('click', function() {
             ...
             setTimeout(function(){
              ...
              $j('html head').find('title').text(  "Finalizando compra no campo [ " + $j(this).attr('name') + " ]"  );
              _gaq.push(['_trackPageview', '#' + $j(this).attr('name') + '']);
              pageTracker._trackEvent("OSC no campo: ", "input_exit", $j(this).attr('name'));
      });
      ...
      $j('input[name*="shipping_method"]').live('click', function() {
              ...
              $j('html head').find('title').text(  "Finalizando compra no campo [ " + $j(this).attr('value') + " ]"  );
