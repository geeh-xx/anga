 ...
 */
class Licentia_Fidelitas_Block_Adminhtml_Autoresponders_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form {
    ...
    public function getEditMode() {
        $campaign = Mage::registry('current_autoresponder');
