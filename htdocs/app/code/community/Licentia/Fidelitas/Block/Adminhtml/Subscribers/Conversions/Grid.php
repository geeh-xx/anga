 ...
 */
class Licentia_Fidelitas_Block_Adminhtml_Subscribers_Conversions_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        $collection = Mage::getModel('fidelitas/conversions')
                ...
                ->addFieldToFilter('subscriber_id', $current->getId());
