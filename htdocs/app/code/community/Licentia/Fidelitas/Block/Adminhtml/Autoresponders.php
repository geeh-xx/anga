...
class Licentia_Fidelitas_Block_Adminhtml_Autoresponders extends Mage_Adminhtml_Block_Widget_Grid_Container {
    ...
    public function __construct() {
        ...
        $this->_headerText = $this->__('Autoresponders');
        $this->_addButtonLabel = $this->__('New Email Autoresponder');

        parent::__construct();
        $this->_updateButton('add', 'onclick', "setLocation('{$this->getUrl("*/*/new", array('type' => 'email'))}')");

            $data = array('label' => $this->__('New SMS Autoresponder'), 'class' => 'add', 'onclick' => "setLocation('{$this->getUrl("*/*/new", array('type' => 'sms'))}')");
